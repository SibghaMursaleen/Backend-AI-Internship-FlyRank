...
<p align="center">
  ...
  Completed during the FlyRank AI Internship program.
</p>
...
This repository contains the weekly assignments and implementations completed during the **FlyRank AI Internship** program. It features hands-on backend development, project documentation, workflow mapping, and analysis of AI integrations.
...
│
├── week 1/
│   ├── Minimal Python backed - Assignement 1/     # FastAPI backend server
│   ├── Workflow Audit - Assignment 2/            # Task audit and documentation
...
<p align="center">
  Built with 🐍 Python &amp; 📝 Markdown &nbsp;·&nbsp; FlyRank AI Internship
</p>
